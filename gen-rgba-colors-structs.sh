...
declare -a COLOR_LIST=(
  'EMERALD+63+195+128' 
  'LIGHT_SEA_GREEN+27+163+156'
  'NIAGARA+42+187+155'
  'JAVA+35+203+167'
  'REBECCA_PURPLE+102+51+153'
  'ELECTRIC_INDIGO+140+20+252'
  'LIME+0+255+0'
  'BLUE+0+0+255'
  'YELLOW+255+255+0'
  'CYAN+0+255+255'
...
for COLOR in ${COLOR_LIST[*]}; do
  ...
  cat << EOF >> src/Colors.jl
  const ${NAME} = [
    $(python3 -c "red=(${RED}/255); print('{:.3f}'.format(red))"),
    $(python3 -c "green=(${GREEN}/255); print('{:.3f}'.format(green))"),
    $(python3 -c "blue=(${BLUE}/255); print('{:.3f}'.format(blue))"),
  ]

  function SetCairoRGBA_${NAME}(ctx)
